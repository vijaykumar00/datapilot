    ...
    <div className="min-h-screen bg-[#030712] text-slate-200 font-sans p-8 overflow-y-auto custom-scrollbar">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <section className="space-y-3.5 text-xs text-slate-300 leading-relaxed">
          ...
          <p>
            When utilizing Gemini, OpenAI, or Claude providers, prompts are forwarded to the respective LLM API endpoint. No database files are used for training models. Stored API keys are encrypted with AES-256 (Fernet) keys at the application layer.
          </p>

          <h2 className="text-sm font-bold text-white uppercase tracking-wider">4. Cookies & Trackers</h2>
          <p>
            We use functional session cookies and local storage tokens to persist authenticated states and preferences. No ad tracking networks are implemented.
          </p>
        </section>
      </div>
    </div>
